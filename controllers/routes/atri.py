...
class Atri:
	def __init__(self, state: Any):
		...
		self.Porfolio_Creater = state["Porfolio_Creater"]
	...
	@property
	def Porfolio_Creater(self):
		self._getter_access_tracker["Porfolio_Creater"] = {}
		return self._Porfolio_Creater
	@Porfolio_Creater.setter
	def Porfolio_Creater(self, new_state):
		self._setter_access_tracker["Porfolio_Creater"] = {}
		global default_state
		self._Porfolio_Creater = TextBox(new_state, default_state["Porfolio_Creater"])
	...
	def _to_json_fields(self):
		return {
			...
			"Flex46": self._Flex46,
			"Flex51": self._Flex51,
			"Porfolio_Creater": self._Porfolio_Creater,
